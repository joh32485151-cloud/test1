def process_text_file_with_ui(input_file: str, output_file: str):
    try:
...
<div id=\"controls\">
    ...
    <select id=\"categoryFilter\">
        ...
        <option value=\"柱區塊圖\">柱區塊圖</option>
        <option value=\"梁區塊圖\">梁區塊圖</option>
        <option value=\"牆區塊圖\">牆區塊圖</option>
        <option value=\"製造圖\">製造圖</option>
    </select>
</div>
...
if __name__ == "__main__":
    ...
    process_text_file_with_ui(input_path, output_path)
